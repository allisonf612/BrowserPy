...
/////////////////////////////////////////////////////////////////////
//                                                                 //
//  With minor modifications by Allison Figus                      //
//  -- removed the isFileEnd function and replaced its usages      //
//     with pIn->good() plus appropriate modifications.            //
//    Reasoning: istream.peek() should not be used to determine    //
//     EOF (isFileEnd was based on istream.peek()                  //
//                                                                 //
/////////////////////////////////////////////////////////////////////
...
Toker::Toker(const std::string& src, bool isFile) throw(std::runtime_error)
     : pIn(0), prevprevChar(0), prevChar(0), currChar(0), nextChar(0),
       numLines(0), braceCount(0), doReturnComments(false),
...
bool Toker::getChar() throw(std::runtime_error)
{
...
bool Toker::isBeginQuote(bool isPlainText)
{
    if (isPlainText)
        return false;
...
std::string Toker::getTok(bool isPlainText)
{
  std::string tok = "";
  try {    
    stripWhiteSpace();
